...
def main():
    ...
    exp_path = os.path.join(path_dataset, f'{args.dataset}-t{str(args.trigger_label)}')
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if test_acc_clean > best_clean_acc and test_bk_acc > best_bk_acc:
    ...
    torch.save(best_cls, f'models/{args.dataset}-dynamic-{str(args.trigger_label)}.pth')
    torch.save(best_ae, f'models/autoencoder/{args.dataset}-ae-{str(args.trigger_label)}.pth')
